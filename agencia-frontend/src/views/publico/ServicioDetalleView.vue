...
const GARANTIAS = [
  'Sin costos ocultos',
  'Soporte incluido post-lanzamiento',
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-7 space-y-8">
              ...
              <div class="p-6 rounded-2xl bg-[#111118] border border-white/6">
                ...
                <ul class="space-y-3">
                  <li v-for="c in servicio.caracteristicas" :key="c" class="flex items-start gap-3">
            ...
            <div class="lg:col-span-5">
              <div class="sticky top-24 space-y-4">
                ...
                <div class="p-6 rounded-2xl bg-[#111118] border border-white/6">
                  <p class="text-xs text-gray-600 uppercase tracking-widest font-semibold mb-3">Inversión</p>
                  ...
                  <RouterLink
                    :to="{
                      name:  'contacto',
                      query: { tipoServicio: servicio.tipo ?? undefined, servicio: servicio.nombre },
                    }"
                ...
                <div class="p-5 rounded-2xl bg-linear-to-br from-violet-600/8 to-indigo-600/6 border border-violet-500/15 space-y-2.5">
                  <div v-for="punto in GARANTIAS" :key="punto" class="flex items-center gap-2.5">
