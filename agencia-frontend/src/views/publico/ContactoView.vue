...
// Si el usuario está logueado, prellenar nombre y correo
const nombreInicial = computed(() => authStore.usuario?.nombre ?? '')
const correoInicial = computed(() => authStore.usuario?.correo ?? '')

onMounted(async () => {
  if (nombreInicial.value) formulario.nombre = nombreInicial.value
  if (correoInicial.value) formulario.correo = correoInicial.value
...
<template>
  <div class="min-h-screen bg-[#0a0a0f]">
    ...
    <div class="fixed inset-0 pointer-events-none overflow-hidden">
      <div class="absolute top-0 left-1/4 w-125500px] bg-violet-600/6 rounded-full blur-[140px]" />
          ...
          <div class="lg:col-span-8">
            ...
            >
              ...
              <div class="space-y-1.5">
                <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wide">
                  Teléfono
                  <span class="normal-case font-normal text-slate-600 ml-1">(opcional)</span>
                </label>
                <input
