...
export const obtenerPorId = async (req: Request, res: Response): Promise<void> => {
  try {
    respuestaExito(res, await servicio.obtenerTestimonioPorId(req.params['id'], true))
  } catch (error) {
...
export const obtenerPorIdAdmin = async (req: Request, res: Response): Promise<void> => {
  try {
    respuestaExito(res, await servicio.obtenerTestimonioPorId(req.params['id']))
  } catch (error) {
    manejarError(res, error, 404)
  }
}
...
export const actualizar = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    respuestaExito(res, await servicio.actualizarTestimonio(req.params['id'], resultado.data), 'Testimonio actualizado correctamente')
  } catch (error) {
    manejarError(res, error)
  }
}
...
export const moderar = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    const datos = await servicio.moderarTestimonio(req.params['id'], resultado.data)
...
export const eliminar = async (req: Request, res: Response): Promise<void> => {
  try {
    respuestaExito(res, await servicio.eliminarTestimonio(req.params['id']), 'Testimonio eliminado correctamente')
  } catch (error) {
    manejarError(res, error)
  }
}