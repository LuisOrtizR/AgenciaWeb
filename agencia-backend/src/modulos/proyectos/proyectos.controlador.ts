...
export const obtenerPorSlug = async (req: Request, res: Response): Promise<void> => {
  try {
    respuestaExito(res, await servicio.obtenerProyectoPorSlug(req.params['slug']))
  } catch (error) {
...
export const obtenerPorId = async (req: Request, res: Response): Promise<void> => {
  try {
    respuestaExito(res, await servicio.obtenerProyectoPorId(req.params['id']))
  } catch (error) {
    manejarError(res, error, 404)
  }
}
...
export const crear = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    respuestaExito(res, datos, 'Proyecto creado correctamente', 201)
  } catch (error) {
...
export const actualizar = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    const datos = await servicio.actualizarProyecto(req.params['id'], resultado.data)
    respuestaExito(res, datos, 'Proyecto actualizado correctamente')
  } catch (error) {
    manejarError(res, error)
  }
}
...
export const toggleDestacado = async (req: Request, res: Response): Promise<void> => {
  try {
    const datos = await servicio.toggleDestacado(req.params['id'])
...
export const eliminar = async (req: Request, res: Response): Promise<void> => {
  try {
    const datos = await servicio.eliminarProyecto(req.params['id'])
    respuestaExito(res, datos, 'Proyecto eliminado correctamente')
  } catch (error) {
    manejarError(res, error)
  }
}